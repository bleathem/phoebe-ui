...
export class TestCaseStatusByTestSuiteBasedOnBuildPackageComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    pieChart1.bindto = '#pie-chart-by-package-1';
    ...
    pieChart2.bindto = '#pie-chart-by-package-2';
    ...
    pieChart3.bindto = '#pie-chart-by-package-3';
    ...
    pieChart4.bindto = '#pie-chart-by-package-4';
    ...
    pieChart5.bindto = '#pie-chart-by-package-5';
    ...
    pieChart6.bindto = '#pie-chart-by-package-6';
